...
<div class="body">
 ...
 color: var(--barbi-pink); width: 100vw; "
  >
    ...
    <br />
    ניסוח אחיד עליו מסכימים כולם, גורם לבני אדם ממדינות, לאומים ותרבויות שונות לבטוח
    זה בזה, לדעת כי ערך החיים נמצא אצל כולם מעל הכל, ולהגיע להסכמה הדדית​
    <br />
  ...
  <div class="rabi">
    ...
    אדון השלום, מלך שהשלום שלו, עושה שלום ובורא הכל. יהי רצון מלפניך שתבטל מלחמות
    ושפיכות דמים מן העולם ותמשיך שלום גדול ונפלא בעולם וְלֹא יִשָּׂא גוֹי אֶל גוֹי
    חֶרֶב וְלֹא יִלְמְדוּ עוֹד מִלְחָמָה, עזרנו והושיענו כולנו שנזכה תמיד לאחוז במידת
    השלום, ויהיה שלום גדול באמת בין כל אדם לחברו, ובין איש לאשתו ולא יהיה שום מחלוקת
    אפילו בלב בין כל בני אדם. ויהיה כל אדם אוהב שלום ורודף שלום תמיד באמת ובלב שלם,
    ולא נחזיק במחלוקת כלל לעולם ואפילו נגד החולקים עלינו ולא נבייש שום אדם בעולם
    מקטן ועד גדול ונזכה לקיים באמת מצוות ואהבת לרעך כמוך בכל לב וגוף ונפש וממון,
    ויקויים בנו מקרא שכתוב,”וְנָתַתִּי שָׁלוֹם בָּאָרֶץ וּשְׁכַבְתֶּם וְאֵין מַחֲרִיד,
    וְהִשְׁבַּתִּי חַיָּה רָעָה מִן הָאָרֶץ, וְחֶרֶב לֹא תַעֲבוֹר בְּאַרְצְכֶם.“.
    ה` שלום, ברכנו בשלום.
  </div>
    ...
    <span class="sec">
      <div style="white-space: nowrap; padding: 5px;">
        <a
          ...
          class="text-barbi"
          >האמנה העולמית לשלום וביטחון ב -<img
            align="left"
            height="32"
            width="32"
            alt="facebook"
        ...
        <div style="white-space: nowrap; padding: 5px;">
          ...
          >
            לקולקציית ה -<img
              ...
              width="32"
              alt="NFT"
              src="https://res.cloudinary.com/love1/image/upload/v1640604252/nft-sign-svgrepo-com_a5xvx7.svg"
            /></a
          >
        </div>
      </div>
