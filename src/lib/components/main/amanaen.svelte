        ...
        if (selected.length < 1) {
          ...
          axios
            ...
            .then((response) => {
              ...
              let linko = `ref=true&id=${response.data.data.id}&con=${find_contry_id(selected)}&un=${$form.name}&em=${mail}&lang=${$lang}`;
              linkos.set(linko);
...
<div class="all">
  ...
  >
    ...
    {:else}
      ...
      >
      <button
        onclick={() => window.open('https://www.1lev1.com/en', '_blank')}
        title="1💗1"
        class="text-barbi border-2 border-gold text-bold hover:text-lturk bg-lturk text-center hover:bg-barbi px-1 py-0.5"
        ><Text1lev1 /></button
      >
        ...
        <div class="card-inner d overflow-y-auto">
          ...
          >
            <span style="font-family:poppins,Gan;">
              ...
              <br />
              I trust in the inherent goodness of humanity, and I hope that when
              all of humanity signs this Convention, violence, conflict, and coercion
