...
onMount(async () =>{
  console.log($lang)
     if ((navigator.userAgent.indexOf('Safari') != -1 && navigator.userAgent.indexOf('Chrome') == -1)) {
      if(localeDir($lang) == "rtl"){
  first = { ...first, [$lang]: reverseString(pick(first)) }
      }
};
})
...
<div class="midscreenText-2 flex flex-col items-center justify-center" dir={localeDir($lang)}>
    <h1 class="a1"  dir={localeDir($lang)}>
     {pick(sh)}
   {$userName}
        </h1>  <h1 class="a2"  dir={localeDir($lang)}>
{pick(sh2)}
          {pick(sh3)}{idx}{pick(sh1)}
</h1><h1 class="a3"  dir={localeDir($lang)}>
  {pick(sh4)}
  {pick(sh5)}
    1💗1
 </h1></div>
...
title={pick(sh6)} class="mt-3 button" onclick={increment}>
<svg class="key" height="80%" width="80%" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="{`600 80 2222 918.656`}" enable-background="new 0 0 2722.126 1518.656" xmlns="http://www.w3.org/2000/svg">
  ...
  <text class="tex"  style="fill: url(#gradient-2); font-family: Arial, sans-serif; font-size: 62px; letter-spacing: 6.1px; stroke: url(#gradient-0); stroke-width: 2.29039px; text-anchor: middle; white-space: pre;" transform="matrix(1.540934, 0, 0, 1.078712, -522.814819, -41.794453)"><tspan x="1365.63" y="486.829">{pick(first)}</tspan><tspan x="1365.63" dy="1em">​</tspan><tspan x="1365.63" dy="1em">​</tspan><tspan x="1365.63" dy="1em">​</tspan><tspan>{pick(second)}</tspan></text>
